...
"""VERSION CONTROL FOR WELCOME STATEMENTS"""
if CURR_ORSEN_VERSION == ORSEN or CURR_ORSEN_VERSION == ORSEN2:
    DIALOGUE_TYPE_WELCOME = "orsen_welcome"
elif CURR_ORSEN_VERSION == EDEN:
    DIALOGUE_TYPE_WELCOME = "eden_welcome"
else: ###ORSEN IS DEFAULT
    DIALOGUE_TYPE_WELCOME = "orsen_welcome"

"""VERSION CONTROL FOR END STATEMENTS"""
if CURR_ORSEN_VERSION == ORSEN or CURR_ORSEN_VERSION == ORSEN2:
    DIALOGUE_TYPE_E_END = "orsen_end"
elif CURR_ORSEN_VERSION == EDEN:
    DIALOGUE_TYPE_E_END = "eden_end"
else: ###ORSEN IS DEFAULT
    DIALOGUE_TYPE_E_END = "orsen_end"
