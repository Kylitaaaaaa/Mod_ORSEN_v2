...
from src.models.dialogue.constants import DIALOGUE_TYPE_PROMPT

class PromptDialogueTemplate(DialogueTemplate):

    def __init__(self, id=-1, template=[], relation=[], blanks=[], nodes=[], dependent_nodes=[]):
        DialogueTemplate.__init__(id, DIALOGUE_TYPE_PROMPT, template, relation, blanks, nodes, dependent_nodes);
